...
<head>
    ...
    <title>User management - Machinery Tracker</title>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-1">
            <div class="bg-white p-6 rounded-xl shadow-md">
                <h2 class="text-2xl font-bold text-gray-800 border-b-2 border-blue-600 pb-2 mb-6">Create New
                    User</h2>
                <form id="createUserForm">
                    <div class="space-y-4">
                        ...
                        <div>
                            <label for="nomina" class="block text-sm font-medium text-gray-700">Payroll</label>
        ...
        <div class="lg:col-span-2">
            <div class="bg-white p-6 rounded-xl shadow-md">
                <h2 class="text-2xl font-bold text-gray-800 border-b-2 border-blue-600 pb-2 mb-6">Current Users</h2>
                <div class="overflow-x-auto">
                    <table id="usersTable" class="w-full text-sm text-left text-gray-500">
                        <thead class="text-xs text-white uppercase bg-gray-700">
                        <tr>
                            <th class="px-6 py-3">Payroll</th>
...
<div id="editUserModal" class="modal fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center p-4">
    <div class="modal-content bg-white rounded-lg shadow-xl w-full max-w-lg p-6 transform scale-95">
        ...
        <form id="editUserForm" class="mt-4">
            ...
            <div class="space-y-4">
                <div>
                    <label for="edit_nombre" class="block text-sm font-medium text-gray-700">Full Name</label>
                    <input type="text" id="edit_nombre" name="nombre" required
                           class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus-ring-grammer">
                </div>
                <div>
                    <label for="edit_nomina" class="block text-sm font-medium text-gray-700">Payroll</label>
                ...
                <div>
                    <label for="edit_correo" class="block text-sm font-medium text-gray-700">E-Mail</label>
                    <input type="email" id="edit_correo" name="correo" required
                           class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus-ring-grammer">
                </div>
                <div>
                    <label for="edit_rol" class="block text-sm font-medium text-gray-700">Role</label>
                ...
                <div>
                    <label for="edit_estatus" class="block text-sm font-medium text-gray-700">Status</label>
