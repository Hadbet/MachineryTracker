...
<head>
    ...
    <title>Admin: Edit Machinery - Machinery Tracker</title>
...
<main class="container mx-auto p-4 md:p-8">
    <div class="bg-white p-6 md:p-8 rounded-xl shadow-md max-w-7xl mx-auto">
        <h2 class="text-2xl font-bold text-gray-800 mb-6">Manage Machinery Records</h2>
        ...
        <form id="editForm" enctype="multipart/form-data">
            <div class="p-6">
                <div class="flex justify-between items-center border-b pb-3">
                    <h2 class="text-2xl font-bold text-gray-800">Edit Record</h2>
                ...
                <div class="mt-4 space-y-6">
                    <!-- Station Data -->
                    <div>
                        <h3 class="text-lg font-semibold text-gray-700 mb-4">Station Data</h3>
                    ...
                    <!-- External Contact -->
                    <div>
                        <h3 class="text-lg font-semibold text-gray-700 mb-4">External Contact</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <!-- Evidences -->
                    <div>
                        <h3 class="text-lg font-semibold text-gray-700 mb-4">Photographic Evidence (upload to
                            replace)</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            <div>
                                <label class="font-medium text-sm">Image Station</label>
                            ...
                            <div id="container_edit_salida">
                                <label class="font-medium text-sm">Evidence Output</label>
                            ...
                            <div id="container_edit_entrada">
                                <label class="font-medium text-sm">Evidence Entry</label>
                            ...
                            <div id="container_edit_resguardo">
                                <label class="font-medium text-sm">Evidence Receipt</label>
            ...
            <div class="bg-gray-50 px-6 py-3 flex justify-end">
                <button type="submit"
                        class="px-4 py-2 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700">Save
                    Changes
                </button>
            </div>
        </form>
